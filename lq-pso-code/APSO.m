...
function [Gbest,fit_iter,div_all]=APSO(fn,X,V,N,D,itmax,fit_iter)
...
while it<=itmax 
    ...
    [X,V,DIV]=update_X_V_Apso(N,X,V,dH,dL,it,itmax,Gbest);
    div_all(it)=DIV;
    fit_iter(it)=Gfit;
...
function [X,V, DIV]=update_X_V_Apso(N,X,V,dH,dL,it,itmax,Gbest)
c1=2.0;
c2=2.0;
global Pbest;
