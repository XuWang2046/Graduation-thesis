function   pso_test_JIAMUSI(   )
    ...
    % close all;
      ...
      X3=X;V3=V;
      [Gbest3,fit_iter3,div_all3]=ARPSO_cxx3(fn,X2,V2,N,D,itermax,fit_iter);
      % [Gbest,fit_iter,div_all]=PSO(fn,X,V,N,D,itermax,fit_iter);
      
      show_res('ARPSOcxx',3,fit_iter3, opti_fun,fn,div_all3 );
      [Pbest,Gbest,Pfit,Gfit]=reini();
      ...
      figure(1)
      legend('NDPSO','ARPSO','ARPSOcxx','LDWPSO')
